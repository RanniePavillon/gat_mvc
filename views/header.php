		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav navbar-right">
					<li><a><?=( !empty($userSession['firstName']) && !empty($userSession['lastName']) ? $userSession['firstName']." ".$userSession['lastName'] : $userSession['username'] )?></a></li>
